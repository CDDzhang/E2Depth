...
from networks.dinov3.dinov3_layers import LayerScale, Mlp, PatchEmbed, RMSNorm, RopePositionEmbedding, SelfAttentionBlock, SwiGLUFFN, named_apply
...
def DINOv3(model_name, 
    ...
    vit_kwargs = dict(
        ...
        embed_dim=model_embed_dim[model_name],
        depth=24 if model_name == "vitl" else 12,
        num_heads=model_num_heads[model_name], 
        ffn_ratio=6 if model_name == "vitsplus" else 4,
        qkv_bias=True,
        layerscale_init=1.0e-05,
        norm_layer="layernormbf16",
        ffn_layer="swiglu" if model_name=="vitsplus" else "mlp",  # plus "swiglu" vitb "mlp" 
        ffn_bias=True,
        proj_bias=True,
        n_storage_tokens=4,
        mask_k_bias=True,
